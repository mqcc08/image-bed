...
@Slf4j
public class HttpClientCheUtil {



    static List<Cookie> globalCookies = null;

    static CookieStore globalCookieStore = null;
    ...
    public static HttpResponseEntity doGet(String url  , Map<String , String> params) {
        ...
        try{
            httpClient = HttpClientBuilder.create().setDefaultCookieStore(globalCookieStore).build();
            //装填参数
            if (params!=null){
            ...
            httpResponseEntity.setCookies(globalCookieStore.getCookies());
            globalCookies = httpResponseEntity.getCookies();
            // 请求发送成功，并得到响应
...
*/
    ...
    public static HttpResponseEntity doPostHttps(String requestUrl , Map<String , String> params , Map<String , String> headers) {
        ...
        try{
            ...
            if (globalCookies != null){
                log.info("===== > 设置 cookies");
                httpClient.setCookieStore(globalCookieStore);
            }
            HttpResponse response = httpClient.execute(httpPost);
            log.info("状态码：" + response.getStatusLine());
            //log.info("状态码：" + JSON.toJSONString(response));
    ...
    public static HttpResponseEntity doUpload(String requestUrl , Map<String , String> params , Map<String , String> headers) {
        // get请求返回结果
        ...
        try{
            ...
            log.info("--- cookies > "+ JSON.toJSONString(globalCookieStore));
